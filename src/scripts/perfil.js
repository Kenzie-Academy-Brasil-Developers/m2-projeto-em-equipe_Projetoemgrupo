...
export async function renderProfile() {
  ...
  main.insertAdjacentHTML(
    ...
    `
            ...
            <div class="cointainer-profile-box">
            ...
            <div class= "data-info-user">
                ...
                <div class="divUserInfos">
                    <p class="descInfo">
                        <span class="purpleText">Nome:</span> ${requestProfilePage.name}
                    </p>
                    <p class="descInfo">
                        <span class="purpleText">Email: </span>${requestProfilePage.email}
                    </p>
                  
                </div>
                <div class="divBtnProfile">
                    <button class="purpleBtn hvr-bounce-out" id="btnUpdate"  data-id=${requestProfilePage.id} data-control-modal="modal-login">Atualizar informações</button>
                    <button class="redBtn hvr-bounce-out" id="delete" data-id=${requestProfilePage.id}>Deletar conta</button>
                </div>
            </div>
            </div>
        </div>
